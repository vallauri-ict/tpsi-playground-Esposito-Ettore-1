...
const server = _http.createServer(function(req, res) {
    ...
    else
    {
        ...
        {
            console.log(JSON.stringify(parametri).green);
            let json = { "ris" : "ok" };
        ...
        else
        {
            ...
            res.write("Il servizio richiesto non esiste".red);
            res.end();
        }
    }

    console.log(`${metodo}: ${risorsa}`.blue);
});
...
console.log(`Il server è in ascolto sulla porta ${PORT}`.yellow);